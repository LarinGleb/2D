...
class Entity():
    ...
    def Move(self, up, left, right, blocks):
        ...
        self._Collider.OnCollisionEnter(self._Collider.CollisionMove, [0, self._Physic._yVelocity], self._Physic, blocks)

        self._Collider.MoveX(self._Physic._xVelocity)

        self._Collider.OnCollisionEnter(self._Collider.CollisionMove, [self._Physic._xVelocity, 0], self._Physic, blocks)
